...
local section_one = findItem(file_manager_dashboard_settings.sub_item_table, "Section 1 (Stats)")
assertEqual(hasItem(section_one.sub_item_table, "All Books"), false, "All Books stays inside Browse")
assertEqual(hasItem(section_one.sub_item_table, "On device"), false, "On device stays inside Browse")
assertEqual(findItem(section_one.sub_item_table, "Authors").mandatory, ">", "Authors shows a drill-down indicator")
assertEqual(findItem(section_one.sub_item_table, "Series").mandatory, ">", "Series shows a drill-down indicator")
assertEqual(findItem(section_one.sub_item_table, "Collections").mandatory, ">", "Collections shows a drill-down indicator")
assertEqual(findItem(section_one.sub_item_table, "Libraries").mandatory, ">", "Libraries shows a drill-down indicator")
assertEqual(findItem(section_one.sub_item_table, "SmartScopes").mandatory, ">", "SmartScopes shows a drill-down indicator")
