...
assertEqual(hasItem(file_manager_dashboard_settings.sub_item_table, "Section 1 (Stats)"), true, "file manager dashboard settings has configurable sections")
...
assertEqual(hasItem(dashboard_dashboard_settings.sub_item_table, "Section 1 (Stats)"), true, "dashboard settings has configurable sections")
assertEqual(hasItem(dashboard_items, "Section 1 (Stats)"), false, "dashboard section settings are not promoted to the dashboard menu top level")
