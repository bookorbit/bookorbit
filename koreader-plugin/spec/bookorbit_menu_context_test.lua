...
assertEqual(hasItem(file_manager_dashboard_settings.sub_item_table, "Row 1 below Continue reading (Discover)"), true, "file manager dashboard settings has the first section picker")
assertEqual(hasItem(file_manager_dashboard_settings.sub_item_table, "Row 2 (Discover)"), true, "file manager dashboard settings has the second section picker")
...
assertEqual(hasItem(dashboard_dashboard_settings.sub_item_table, "Row 1 below Continue reading (Discover)"), true, "dashboard settings has the first section picker")
assertEqual(hasItem(dashboard_dashboard_settings.sub_item_table, "Row 2 (Discover)"), true, "dashboard settings has the second section picker")
assertEqual(hasItem(dashboard_items, "Row 1 below Continue reading (Discover)"), false, "the section picker is not promoted to the dashboard menu top level")
