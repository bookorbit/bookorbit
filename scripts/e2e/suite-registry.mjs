...
export const E2E_SUITES = Object.freeze({
  ...
  "scanner-manual-books": {
    id: "scanner-manual-books",
    name: "Scanner Manual Books",
    timeout: 30,
    lane: "full",
    description: "Manual-origin books survive scans untouched",
    vitestTarget: "test/scanner-manual-books.e2e-spec.ts",
    junitOutput: `${TEST_RESULTS_DIR}/scanner-manual-books-e2e-junit.xml`,
    prepareDedicatedDatabase: true,
    useDedicatedDatabase: true,
    changedPaths: [
      "server/src/modules/scanner/**",
      "server/src/db/schema/**",
      "server/test/scanner-manual-books.e2e-spec.ts",
      "server/test/e2e/scanner/**",
      ".github/workflows/e2e-runner.yml",
      ...SHARED_DB_AND_HELPER_PATHS,
    ],
