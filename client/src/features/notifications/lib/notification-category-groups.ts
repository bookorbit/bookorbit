import { FileCog, FolderSync, HardDriveDownload, Mail, RefreshCw, ScanLine, Tags, Trophy, Users, type LucideIcon } from '@lucide/vue'
...
export const NOTIFICATION_CATEGORY_GROUPS = [
  ...
  { id: 'integrations', categories: ['bookDock', 'email'] },
